...
from AltBots.data import RAID, REPLYRAID, ALTRON, MRAID, SRAID, CRAID, ALTRON, BRAID, ORAID, RRAID
...
async def rraid(e):
    if e.sender_id in SUDO_USERS:
        ...
        try:
            ...
            await e.reply(f"𝗠𝗼𝗱𝘂𝗹𝗲 𝗡𝗮𝗺𝗲: 𝐑𝐞𝐩𝐥𝐲𝐑𝐚𝐢𝐝\n  » {hl}replyraid <ᴜꜱᴇʀɴᴀᴍᴇ ᴏꜰ ᴜꜱᴇʀ>\n  » {hl}replyraid <ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴜꜱᴇʀ>/n » 𝒟ℰ𝒱ℰℒ𝒪𝒫ℰℛ~> @Dark_Ravan_01")
...
async def drraid(e):
    if e.sender_id in SUDO_USERS:
        ...
        try:
            ...
            await e.reply(f"𝗠𝗼𝗱𝘂𝗹𝗲 𝗡𝗮𝗺𝗲: 𝐃𝐑𝐞𝐩𝐥𝐲𝐑𝐚𝐢𝐝\n  » {hl}dreplyraid <ᴜꜱᴇʀɴᴀᴍᴇ ᴏꜰ ᴜꜱᴇʀ>\n  » {hl}dreplyraid <ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴜꜱᴇʀ>/n » 𝒟ℰ𝒱ℰℒ𝒪𝒫ℰℛ~> @Dark_Ravan_01")
